...
const Button = ({img, label, onClick, disabled}) => {
  return (
    <div>
      <button onClick={onClick} disabled={disabled} type="submit" className="btn w-full text-xs uppercase px-8 py-6 rounded-xl bg-teal-800 text-white border-none relative overflow-hidden group z-10">
