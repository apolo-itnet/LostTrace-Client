...
const SecondaryBtn = ({ label, img, onClick,  type = "button", disabled, className = ""   }) => {
  return (
    <button onClick={onClick} type={type} className="btn border-none shadow-none bg-transparent hover:bg-transparent relative cursor-pointer py-6 px-6 text-center font-barlow flex justify-center items-center text-sm uppercase rounded-lg transition-transform duration-300 ease-in-out group outline-offset-4 focus:outline focus:outline-2 focus:outline-transparent focus:outline-offset-4 overflow-hidden">
